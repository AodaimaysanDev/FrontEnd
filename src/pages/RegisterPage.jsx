            ...
            <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input type="text" id="username" value={username} onChange={e => setUsername(e.target.value)} className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required />
                    </div>
                    <div className="mb-4">
